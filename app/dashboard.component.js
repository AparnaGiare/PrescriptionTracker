...
var DashboardComponent = (function () {
    function DashboardComponent(router, pharmaciesService) {
        this.router = router;
    ...
    DashboardComponent.prototype.ngOnInit = function () {
        ...
        this.pharmaciesService.getPharmacies()
            .then(function (pharmacies) { return _this.pharmacies = pharmacies.slice(1, 5); });
    };
    DashboardComponent.prototype.gotoDetail = function (pharmacy) {
